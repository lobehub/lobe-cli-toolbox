...
seo:
  title: >-
    Server-Side Development for Plugins - Implementing API Interfaces and Edge Runtime

  description: >-
    Learn about implementing server-side functionality for plugins, including Edge Runtime usage, error handling, and gateway setup.
