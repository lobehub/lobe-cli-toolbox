...
seo:
  title: >-
    Server-side Development of Plugins - Implementing API Interfaces and
    Gateways
  description: >-
    Learn about implementing server-side API interfaces and gateways for plugin
    development, including examples and support for OpenAPI manifest.
  tags:
