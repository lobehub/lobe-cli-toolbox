...
group: Hooks
seo:
  title: useOnStandalonePluginInit - React Plugin Initialization Event Listener
  description: >-
    Listen for the initialization of standalone plugins within a React functional component, and process the payload of the initialization event.
